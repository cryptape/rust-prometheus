...
#[derive(PartialEq,Clone,Default)]
pub struct MetricFamilyVec {
    // message fields
    metrics: ::protobuf::RepeatedField<MetricFamily>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for MetricFamilyVec {}

impl MetricFamilyVec {
    pub fn new() -> MetricFamilyVec {
        ::std::default::Default::default()
    }

    pub fn default_instance() -> &'static MetricFamilyVec {
        static mut instance: ::protobuf::lazy::Lazy<MetricFamilyVec> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const MetricFamilyVec,
        };
        unsafe {
            instance.get(MetricFamilyVec::new)
        }
    }
    ...
    // Param is passed by value, moved
    pub fn set_metrics(&mut self, v: ::protobuf::RepeatedField<MetricFamily>) {
        self.metrics = v;
    }

    // Mutable pointer to the field.
    pub fn mut_metrics(&mut self) -> &mut ::protobuf::RepeatedField<MetricFamily> {
        &mut self.metrics
    }

    // Take field
    pub fn take_metrics(&mut self) -> ::protobuf::RepeatedField<MetricFamily> {
        ::std::mem::replace(&mut self.metrics, ::protobuf::RepeatedField::new())
    }

    pub fn get_metrics(&self) -> &[MetricFamily] {
        &self.metrics
    }

    fn get_metrics_for_reflect(&self) -> &::protobuf::RepeatedField<MetricFamily> {
        &self.metrics
    }

    fn mut_metrics_for_reflect(&mut self) -> &mut ::protobuf::RepeatedField<MetricFamily> {
        &mut self.metrics
    }
}

impl ::protobuf::Message for MetricFamilyVec {
    fn is_initialized(&self) -> bool {
...
impl ::protobuf::MessageStatic for MetricFamilyVec {
    fn new() -> MetricFamilyVec {
        MetricFamilyVec::new()
    }

    fn descriptor_static(_: ::std::option::Option<MetricFamilyVec>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                let mut fields = ::std::vec::Vec::new();
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<MetricFamily>>(
                    "metrics",
                    MetricFamilyVec::get_metrics_for_reflect,
                    MetricFamilyVec::mut_metrics_for_reflect,
                ));
                ::protobuf::reflect::MessageDescriptor::new::<MetricFamilyVec>(
                    "MetricFamilyVec",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for MetricFamilyVec {
    fn clear(&mut self) {
        self.clear_metrics();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for MetricFamilyVec {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for MetricFamilyVec {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    .MetricR\x06metric\"O\n\x0fMetricFamilyVec\x12<\n\x07metrics\x18\x01\x20\
    \x03(\x0b2\".io.prometheus.client.MetricFamilyR\x07metrics*M\n\nMetricTy\
    pe\x12\x0b\n\x07COUNTER\x10\0\x12\t\n\x05GAUGE\x10\x01\x12\x0b\n\x07SUMM\
    ARY\x10\x02\x12\x0b\n\x07UNTYPED\x10\x03\x12\r\n\tHISTOGRAM\x10\x04B\x16\
    \n\x14io.prometheus.clientJ\xd0\x18\n\x06\x12\x04\r\0T\x01\n\xbc\x04\n\
    \x01\x0c\x12\x03\r\0\x122\xb1\x04\x20Copyright\x202013\x20Prometheus\x20\
    ...
    \x04\x04\x02\x01\x01\x12\x03.\x14\x1e\n\x0c\n\x05\x04\x04\x02\x01\x03\
